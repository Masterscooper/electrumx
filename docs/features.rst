...
- Fast synchronization of dogegpu mainnet from Genesis.  Recent
...
* investigate speaking the DogeGPU protocol and connecting to the
  DogeGPU network directly for some queries.  This could lead to
