...
The project is hosted on `GitHub <https://github.com/Electrum-DOGPU-SIG/electrumx-dogegpu>`_.

Please submit an issue on the `bug tracker
<https://github.com/Electrum-DOGPU-SIG/electrumx-dogegpu/issues>`_ if you have found a
...
<https://github.com/Electrum-DOGPU-SIG/electrumx-dogegpu/LICENCE>`_.
