...
.. note:: ElectrumX will not serve any incoming connections until it has fully caught up
          with your dogegpu daemon.  The only exception is local **RPC** connections,
...
.. envvar:: BANNER_FILE
  ...
  See `here <https://github.com/Electrum-DOGPU-SIG/electrumx-banner-updater>`_
...
.. envvar:: INITIAL_CONCURRENT
  ...
  to process it.  Factors include whether the request uses doged, how much bandwidth
...
.. _lib/coins.py: https://github.com/Electrum-DOGPU-SIG/electrumx-dogegpu/blob/master/electrumx/lib/coins.py
