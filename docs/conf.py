...
#
html_theme_options = {
    'description': 'Lightweight Electrum DogeGPU Server in Python',
    'github_user': 'Electrum-DOGPU-SIG',
...
latex_documents = [
    (master_doc, 'ElectrumX.tex', 'ElectrumX DogeGPU Documentation',
...
man_pages = [
    (master_doc, 'electrumx', 'ElectrumX DogeGPU Documentation',
     [author], 1)
]
